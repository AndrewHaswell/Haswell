    ...
    <tr class="col-md-10 col-md-offset-1">
      ...
      <table class="table table-striped table-hover">
        ...
        <tr>
          ...
          <td>
            <span class="editable" id="portion_{{$ingredient->id}}">{{$ingredient->portion}}</span>
          </td>
          <td>
            <span class="editable" id="pack_{{$ingredient->id}}">{{$ingredient->pack}}</span>
          </td>
          <td>
            <table class="table table-bordered table-striped">
              <tr>
                ...
                <td>
                  <div class="nutrition"><span class="editable"
                                               id="energy_{{$ingredient->id}}">{{round($ingredient->energy, 2)}}</span>
                  </div>
                  Kcal
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <div class="nutrition"><span class="editable"
                                               id="fat_{{$ingredient->id}}">{{round($ingredient->fat, 2)}}</span></div>
                  g&nbsp;&nbsp;(
                  <div class="nutrition"><span class="editable"
                                               id="saturates_{{$ingredient->id}}">{{round($ingredient->saturates, 2)}}</span>
                  </div>
                  g)
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <div class="nutrition"><span class="editable"
                                               id="carb_{{$ingredient->id}}">{{round($ingredient->carb, 2)}}</span>
                  </div>
                  g&nbsp;&nbsp;(
                  <div class="nutrition"><span class="editable"
                                               id="sugars_{{$ingredient->id}}">{{round($ingredient->sugars, 2)}}</span>
                  </div>
                  g)
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <div class="nutrition"><span class="editable"
                                               id="fibre_{{$ingredient->id}}">{{round($ingredient->fibre, 2)}}</span>
                  </div>
                  g
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <div class="nutrition"><span class="editable"
                                               id="protein_{{$ingredient->id}}">{{round($ingredient->protein, 2)}}</span>
                  </div>
                  g
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <div class="nutrition"><span class="editable"
                                               id="salt_{{$ingredient->id}}">{{round($ingredient->salt, 2)}}</span>
                  </div>
                  g
                </td>
              </tr>
