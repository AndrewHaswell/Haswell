...
class BudgetController extends Controller
{
    ...
    public function index()
    {
        ...
        $updates = Payment::where('budget_id', '>', '0')->whereDate('start_date', '>=',
            Carbon::now('Europe/Stockholm'))->whereDate('end_date', '>', Carbon::now('Europe/Stockholm'))->get();
        ...
        return view('budget.details', compact([
          'main_categories',
          'cat_updates',
          'incoming'
        ]));
